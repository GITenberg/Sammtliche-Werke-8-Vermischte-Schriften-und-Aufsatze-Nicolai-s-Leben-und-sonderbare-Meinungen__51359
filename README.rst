...
This is a git repository of the source files for the book Sämmtliche Werke 8: Vermischte Schriften und Aufsätze
Nicolai's Leben und sonderbare Meinungen / Deducirter Plan einer zu Berlin zu errichtenden höheren Lehranstalt / Beweis der Unrechtmässigkeit des Büchernachdrucks und andere Aufsätze / Recensionen / Poesien und metrische Uebersetzungen by Johann Gottlieb Fichte. This book is in the Public Domain, see the LICENSE file for details.
...
Technical details
=================
The main source file for this book will be a file with a name containing `51359` with a file extension (ex. `.txt`, `.rst`, `.tei`, `.tex`). Some books also contain generated ebooks, html versions, and images/figures from the text as image files. Eventually, there will be generated ebooks in the downloads area.
